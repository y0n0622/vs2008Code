...
{
	return CWnd::Create(_T("DESKBUTTON"), lpszWindowName, dwStyle, rect, pParentWnd, nID);
}

void CDeskButton::SetImage(UINT uIDResource)
{
...
LRESULT CDeskButton::OnMouseHover(WPARAM wParam, LPARAM lParam)
{
	return TRUE;
}

LRESULT CDeskButton::OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
	return TRUE;
}
